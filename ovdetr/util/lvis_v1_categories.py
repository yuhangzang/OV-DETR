...
LVIS_CATEGORIES = [{
    ...
    'arctic.n.02',
    'synonyms': [
        'arctic_(type_of_shoe)', 'galosh', 'golosh', 'rubber_(type_of_shoe)',
        'gumshoe'
    ],
    'id':
    17,
    ...
    208,
    'def':
    'a wheeled vehicle adapted to the rails of railroad (mark each individual railcar separately)',
    'name':
    ...
    'id': 215,
    'def':
    'plant with pink to purple-red spice-scented usually double flowers',
    'name': 'carnation'
}, {
    'frequency': 'c',
    ...
    'cocoa.n.01',
    'synonyms':
    ['cocoa_(beverage)', 'hot_chocolate_(beverage)', 'drinking_chocolate'],
    'id':
    282,
    'def':
    ...
    'id': 309,
    'def':
    'ears or kernels of corn that can be prepared and served for human food (only mark individual ears or kernels)',
    'name': 'edible_corn'
}, {
    'frequency': 'r',
    ...
    'id': 345,
    'def':
    'a metal award or cup-shaped vessel with handles that is awarded as a trophy to a competition winner',
    'name': 'trophy_cup'
}, {
    'frequency': 'f',
    ...
    374,
    'def':
    'dishsoap or dish detergent designed for use in dishwashers',
    'name':
    ...
    'id': 404,
    'def':
    'a large cylindrical bag of heavy cloth (does not include suitcases)',
    'name': 'duffel_bag'
}, {
    'frequency': 'r',
    ...
    'id': 455,
    'def':
    'any broad thin covering attached at one edge, such as a mud flap next to a wheel or a flap on an airplane wing',
    'name': 'flap'
}, {
    'frequency': 'r',
    'synset': 'flash.n.10',
    ...
    'id': 525,
    'def':
    'a small net that someone wears over their hair to keep it in place',
    'name': 'hairnet'
}, {
    'frequency': 'c',
    'synset': 'hairpin.n.01',
    ...
    'id': 553,
    'def':
    'a muscular organ; its contractions move the blood through the body',
    'name': 'heart'
}, {
    'frequency': 'c',
    'synset': 'heater.n.01',
    ...
    'hookah.n.01',
    'synonyms':
    ['hookah', 'narghile', 'nargileh', 'sheesha', 'shisha', 'water_pipe'],
    'id':
    567,
    'def':
    'a tobacco pipe with a long flexible tube connected to a container where the smoke is cooled by passing through water',
    'name':
    'hookah'
}, {
    'frequency': 'r',
    ...
    'synonyms':
    ['measuring_stick', 'ruler_(measuring_stick)', 'measuring_rod'],
    'id':
    681,
    'def':
    ...
    'id': 684,
    'def':
    'fruit of the gourd family having a hard rind and sweet juicy flesh',
    'name': 'melon'
}, {
    'frequency': 'f',
    ...
    'id': 705,
    'def':
    'a computer input device that controls an on-screen pointer (does not include trackpads / touchpads)',
    ...
    'id': 719,
    'def':
    'a daily or weekly publication on folded sheets containing news, articles, and advertisements',
    'name': 'newspaper'
}, {
    'frequency': 'c',
    ...
    'id': 738,
    'def':
    'a thick standalone cushion used as a seat or footrest, often next to a chair',
    'name': 'ottoman'
}, {
    'frequency': 'f',
    'synset': 'oven.n.01',
    ...
    'id': 891,
    'def':
    'a shoe with pairs of rollers (small hard wheels) fixed to the sole',
    'name': 'roller_skate'
}, {
    'frequency': 'r',
    ...
    948,
    'def':
    'common footwear covering the foot',
    'name':
    'shoe'
}, {
    'frequency': 'f',
    ...
    'id': 1029,
    'def':
    'a pointed tool for writing or drawing or engraving, including pens',
    'name': 'stylus'
}, {
    'frequency': 'r',
    ...
    'id': 1072,
    'def':
    'electronic device for communicating by voice over long distances (includes wired and wireless/cell phones)',
    'name': 'telephone'
}, {
    'frequency':
    'c',
    'synset':
    'telephone_booth.n.01',
    'synonyms': [
    ...
    'washbasin.n.01',
    'synonyms':
    ['washbasin', 'basin_(for_washing)', 'washbowl', 'washstand', 'handbasin'],
    'id':
    1159,
    'def':
