...
class CocoEvaluator(object):
    def __init__(self, coco_gt, iou_types, cat2label, label_map=False):
        ...
        if label_map:
            ...
            self.unseen_list = [4, 5, 16, 17, 20, 21, 27, 31, 35, 40, 46, 48, 60, 62, 75, 80, 86]
                ...
                [
                    {
                        ...
                        "category_id": self.label2cat[labels[k]] if self.label_map else labels[k],
                        "bbox": box,
                        "score": scores[k],
                    }
